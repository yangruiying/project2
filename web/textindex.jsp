...
<form  method="post" >
	...
	<%
		...
		PreparedStatement pst = con.prepareStatement("select * from 教材 ");
		ResultSet re=pst.executeQuery();
		String msg="textindex.jsp";
		String table="教材";
		while(re.next())
		{
			out.println("<tr>");
			out.println("<td>"+re.getString(1)+"</td><td>"+re.getString(3)+"</td><td><a href='delete.jsp?id="+re.getString(2)+"&msg="+msg+"&table="+table+"' onclick='return check();'/>删除</td>");
			out.println("</tr>");
		}
%>
	<tr>
		<td><a href="text.jsp">添加教材</a></td>
	</tr>
	</table>
</form>
</div>
